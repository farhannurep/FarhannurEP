package id.ac.poliban.mi.farhannur037.roomwordssampledelete;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.farhannur037.roomwordssampledelete.REPLY";
